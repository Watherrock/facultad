<?php
/*alta_profesor.php
 *Recibe el id de consulta_profesor.php, para eliminar el registro
 * authoe: ian
 * date: 2021 04 22
 */ 
//print_r($_POST);
...
if ($con){
    ...
    $query = "select id_profesor,nombre_profesor,apaterno_profesor,amaterno_profesor,tel_profesor,correoe_profesor from profesores where id_profesor=".$id;
...
<?php
    ...
    echo "<tr>";
    echo "<td>".$consulta['id_profesor']."</td>";
    echo "<td>".$consulta['nombre_profesor']."</td>";
    echo "<td>".$consulta['apaterno_profesor']."</td>";
    echo "<td>".$consulta['amaterno_profesor']."</td>";
    echo "<td>".$consulta['correoe_profesor']."</td>";
    echo "<td>".$consulta['tel_profesor']."</td>";
    echo "</tr>";
...
<?php
    ...
    if ($borrar){     
        ...
        if ($query) {
            echo "<p>Se elimino el registro de profesores</p>";
