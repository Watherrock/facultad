...
?>
	<h1>Formulario de edita de alumnos</h1>
	<p>Favor ingresar los siguientes datos para editar a los alumnos</p>
	<form name="editar" action="./actualiza_alumno.php" method="post">
		...
		<input type="text" name="tel" value="<?php echo $resultado['tel_alumno']; ?>"><br />
